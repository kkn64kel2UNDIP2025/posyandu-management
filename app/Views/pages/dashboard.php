...
<!-- Main Content -->
        <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-x-6 gap-x-0 lg:gap-y-0 gap-y-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="flex  justify-between mb-5">
                            <h4 class="text-gray-900 text-lg font-semibold sm:mb-0 mb-2">Profit &
                                Expenses</h4>
                            <div
            ...
            <div class="flex flex-col gap-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="text-gray-900 text-lg font-semibold mb-4">Traffic Distribution</h4>
                        <div class="flex items-center justify-between gap-12">
                            <div>
                                <h3 class="text-[22px] font-semibold text-gray-900 mb-4">$36,358</h3>
                                <div class="flex items-center gap-1 mb-3">
                                    ...
                                    <p class="text-gray-900 text-sm font-normal ">+9%</p>
                    ...
                    <div class="card-body">
                        <div class="flex gap-6 items-center justify-between">
                            <div class="flex flex-col gap-4">
                                <h4 class="text-gray-900 text-lg font-semibold">Product Sales</h4>
                                <div class="flex flex-col gap-4">
                                    <h3 class="text-[22px] font-semibold text-gray-900">$6,820</h3>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-x-6 gap-x-0 lg:gap-y-0 gap-y-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="text-gray-900 text-lg font-semibold mb-5">Upcoming Schedules</h4>
                    <ul class="timeline-widget relative">
                        <li class="timeline-item flex relative overflow-hidden min-h-[70px]">
                            <div
                                class="timeline-time text-gray-900 text-sm min-w-[90px] py-[6px] pr-4 text-end">
                                9:30 am
                            </div>
                            ...
                            <div class="timeline-desc py-[6px] px-4">
                                <p class="text-gray-900 text-sm font-normal">Payment received from John
                                    Doe of $385.90</p>
                            </div>
                        </li>
                        <li class="timeline-item flex relative overflow-hidden min-h-[70px]">
                            <div
                                class="timeline-time text-gray-900 min-w-[90px] py-[6px] text-sm pr-4 text-end">
                                10:00 am
                            </div>
                            <div class="timeline-badge-wrap flex flex-col items-center ">
                                <div
                            ...
                            <div class="timeline-desc py-[6px] px-4 text-sm">
                                <p class="text-gray-900  font-semibold">New sale recorded</p>
                        ...
                        <li class="timeline-item flex relative overflow-hidden min-h-[70px]">
                            <div
                                class="timeline-time text-gray-900 min-w-[90px] text-sm py-[6px] pr-4 text-end">
                                12:00 am
                            </div>
                            <div class="timeline-badge-wrap flex flex-col items-center ">
                                <div
                            ...
                            <div class="timeline-desc py-[6px] px-4">
                                <p class="text-gray-900 text-sm font-normal">Payment was made of $64.95
                                    to Michael</p>
                            </div>
                        </li>
                        ...
                        <li class="timeline-item flex relative overflow-hidden min-h-[70px]">
                            ...
                            <div class="timeline-desc py-[6px] px-4">
                                <p class="text-gray-900 text-sm font-semibold">New arrival recorded</p>
                            </div>
                        </li>
                        <li class="timeline-item flex relative overflow-hidden">
                            ...
                            <div class="timeline-desc py-[6px] px-4">
                                <p class="text-gray-900 text-sm font-normal">Payment Done</p>
                            </div>
                        </li>
            ...
            <div class="col-span-2">
                <div class="card h-full">
                    <div class="card-body">
                        <h4 class="text-gray-900 text-lg font-semibold mb-5">Top Paying Clients</h4>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-4 lg:grid-cols-2 gap-6">
            <div class="card overflow-hidden">
                ...
                <div class="card-body">
                    <h6 class="text-base font-semibold text-gray-900 mb-1">Boat Headphone</h6>
                    <div class="flex justify-between">
                        <div class="flex gap-2 items-center ">
                            <h6 class=" text-gray-900 font-semibold text-base">$50</h6>
            ...
            <div class="card overflow-hidden">
                ...
                <div class="card-body">
                    <h6 class="text-base font-semibold text-gray-900 mb-1">MacBook Air Pro</h6>
                    <div class="flex justify-between">
                        <div class="flex gap-2 items-center">
                            <h6 class="text-base text-gray-900 font-semibold">$650</h6>
            ...
            <div class="card overflow-hidden">
                ...
                <div class="card-body">
                    <h6 class="text-base font-semibold text-gray-900 mb-1">Red Valvet Dress</h6>
                    <div class="flex justify-between">
                        <div class="flex gap-2 items-center">
                            <h6 class="text-base text-gray-900 font-semibold">$150</h6>
                            <span class="text-gray-400 text-sm opacity-80">
                                <del>$200</del>
                            </span>
                        </div>
            ...
            <div class="card overflow-hidden">
                ...
                <div class="card-body">
                    <h6 class="text-base font-semibold text-gray-900 mb-1">Cute Soft Teddybear</h6>
                    <div class="flex justify-between">
                        <div class="flex gap-2 items-center">
                            <h6 class="text-base text-gray-900 font-semibold">$285</h6>
